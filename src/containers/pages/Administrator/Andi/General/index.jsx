...
function General(props) {
    ...
    const add = global => {
        ...
        axios.post(`${REST.server.andinaeta}api/generals`, fd)
            .then(res => {
                setGenerals(generals.concat(res.data));
    ...
    const show = id => {
        axios.get(`${REST.server.andinaeta}api/generals?id=${id}`)
            .then(res => {
                setDetails(res.data);
    ...
    const deleteGeneral = () => {
        ...
        axios.get(`${REST.server.andinaeta}api/generals`, { params: s })
            .then(res => {
                setIsLoading(false);
