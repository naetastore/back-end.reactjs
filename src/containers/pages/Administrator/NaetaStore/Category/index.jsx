...
function Category(props) {
    ...
    const add = category => {
        ...
        axios.post(`${REST.server.naetastore}api/category`, category)
            .then(res => {
    ...
    const show = id => {
        axios.get(`${REST.server.naetastore}api/category?id=${id}`)
            .then(res => {
    ...
    const deleteCategory = id => {
        ...
        axios.get(`${REST.server.naetastore}api/category`, { params: s })
            .then(res => {
                setIsLoading(false);
