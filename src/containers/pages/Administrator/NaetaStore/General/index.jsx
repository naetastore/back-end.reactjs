...
function General(props) {
    ...
    const add = global => {
        ...
        axios.post(`${REST.server.naetastore}api/general`, fd)
            .then(res => {
                setGenerals(generals.concat(res.data.general));
    ...
    const show = id => {
        axios.get(`${REST.server.naetastore}api/general?id=${id}`)
            .then(res => {
    ...
    const deleteGeneral = () => {
        ...
        axios.get(`${REST.server.naetastore}api/general`, { params: s })
            .then(res => {
                setIsLoading(false);
