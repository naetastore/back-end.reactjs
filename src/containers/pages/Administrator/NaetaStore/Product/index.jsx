...
function Product(props) {
    ...
    const getData = () => {
        ...
        axios.get(`${REST.server.naetastore}api/product`)
            .then(res => {
    ...
    const show = id => {
        axios.get(`${REST.server.naetastore}api/product?id=${id}`)
            .then(res => {
    ...
    const update = product => {
        ...
        axios.post(`${REST.server.naetastore}api/product`, fd)
            .then(res => {
                setIsLoading(false);
                // let data = [...products];
    ...
    const add = product => {
        ...
        axios.post(`${REST.server.naetastore}api/product`, fd)
            .then(res => {
                setProducts(products.concat(res.data.product));
    ...
    const deleteProduct = () => {
        ...
        axios.get(`${REST.server.naetastore}api/product`, { params: s })
            .then(res => {
                setIsLoading(false);
